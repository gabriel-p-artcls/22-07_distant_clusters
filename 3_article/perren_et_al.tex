...
\section{Results and discussion}
 ...
 \end{itemize}
  ...
  200 \\[.2cm]
  BH4 & 0.0079$_{0.0017}^{0.0245}$ & $-0.28_{-0.96}^{0.24}$ & 9.14 $_{8.75}^{9.42 }$ & 0.42$_{0.08}^{0.48}$ &
  14.48$_{13.90}^{15.32}$ & 7.89$_{6.03}^{11.58}$ & 1.9E+03$_{1.0E+03}^{3.5E+03}$ & 0.62$_{0.29}^{0.86}$ &
  70 \\[.2cm]
 ...
 \subsection{Cluster by cluster discussion}
  ...
  respectively.
  \textbf{\cite{Carraro_2007_oldOC} 1.5 Gyr, 11.5 kpc TODO}
  Our results thus show that this is a cluster located well below
  ...
  the one we found.
  \textbf{\cite{Carraro_2007_oldOC} 5 Gyr, 13.2 kpc TODO}
  Along with a better parameter estimation performed by 
  ...
  found that this title actuallly corresponds to Berkeley 29, which is $\sim2$
 ...
 \subsection{Metallicity gradient}
  ...
  one shown in~\citet[][their Fig. 4]{Salaris_2004}
...
\label{app:galac_dynam}
  ...
  \begin{table*}
   ...
   \begin{tabular}{lcccccccc}
    ...
    BH4 & 13.10 & -10.80  & -7.35 & -0.95 & $-0.82  \pm 0.14$ & $2.12 \pm 0.16$ & --  \\
