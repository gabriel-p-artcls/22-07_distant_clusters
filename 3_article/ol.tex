...
\section{Results and discussion}
 ...
 \end{itemize}
  ...
  % \begin{table}
  % \caption{xxx}
  % \label{tab:dist_differences}
  % \centering
  % \begin{tabular}{llll}
  % \hline\hline
  % Database & $d\geq9$ Kpc &  $d<9$ Kpc & $\log$(age)\\
  % \hline
  %  MWSC          & xx$\pm$xx &  xx$\pm$xx &  xx$\pm$xx\\
  %  WEBDA         & xx$\pm$xx &  xx$\pm$xx &  xx$\pm$xx\\
  %  OPENCLUST     & xx$\pm$xx &  xx$\pm$xx &  xx$\pm$xx\\
  %  Cantat-Gaudin & xx$\pm$xx &  xx$\pm$xx &  xx$\pm$xx\\
  % \hline
  % \end{tabular}
  % \end{table}
