...
\section{Cluster analysis}
 \label{sec:clust_analy}
  ...
  \begin{tabular}{lllllllllll}
  \hline\hline
  Cluster & radius  & $r_{c}$  &  $r_{t}$\\
  \hline
   ARPM2  & 3    & 1.38 & 4.01\\
   BER102 & 2.5  & 0.98 & 4.39\\
   BER25  & 5    & 1.48 & 7.03\\
   BER26  & 1.6  & 0.70 & 3.78\\
   BER29  & 2    & 0.50 & 5.42\\
   BER56  & 4.5  & 1.58 & 7.99\\
   ...
   BER75  & 2    & 0.40 & 5.07\\
   BER76  & 4    & 1.65 & 7.77\\
   CZER30 & 2.5  & 0.57 & 6.22\\
   E09205 & 3    & 1.07 & 4.24\\
   E09218 & 3    & 0.60 & 6.76\\
   E09308 & 1.5  & 0.21 & 5.05\\
   F1212  & 3    & 0.86 & 9.20\\
   F1419  & 3    & 1.31 & 5.05\\
   KRON31 & 2    & 0.46 & 6.69\\
   KRON39 & 2    & 0.27 & 5.52\\
  ...
  \begin{figure}
  \centering
   \includegraphics[width=\hsize]{figs/ber29_A23.png}
   \caption{xxx}
   \label{fig:BER29_centrad}
  \end{figure}

  \begin{figure}
  \centering
   \includegraphics[width=\hsize]{figs/BER29_membs.png}
   \caption{xxx}
   \label{fig:BER29_membs}
  \end{figure}
